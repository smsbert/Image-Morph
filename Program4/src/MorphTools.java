...
public class MorphTools
{
 ...
 r
        ...
        ********************************************************/
        ...
        int[] xcoords = S.getXcoords();
        int[] ycoords = S.getYcoords();
        for (int i = 0; i < 3; ++i) {
            a[i][0] = xcoords[i];
            a[i][1] = ycoords[i];
            a[i][2] = 1.0;
        ...
        int[] xcoorddest = D.getXcoords();
        int[] ycoorddest = D.getYcoords();
        ...
        destPath.moveTo((float)D.getX1(), (float)D.getY1());
        destPath.lineTo((float)D.getX2(), (float)D.getY2());
        destPath.lineTo((float)D.getX3(), (float)D.getY3());
        destPath.lineTo((float)D.getX1(), (float)D.getY1());
